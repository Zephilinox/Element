                                              ...
                                              const source_information& source_info) const
{
    ...
    auto predicate_expression = std::dynamic_pointer_cast<const element_expression>(frame.compiled_arguments[0]);
    predicate_expression->actual_type = type::num.get();
    return list_wrapper::create_or_optimise(std::move(predicate_expression), {frame.compiled_arguments[2], frame.compiled_arguments[1]}, source_info);
}
